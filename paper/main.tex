...
%Community \#1432 is one of many strands of research now woven together. We have chosen it as our focus because, of the primordial soup from which the modern conception of misinformation emerged, it was the most established, and, as we have argued, it is often excluded.

As discussed in Section~\ref{results}, these parallels are not a coincidence. Today's paradigm inherits from its predecessors across many fields. At its core, it focuses on individuals consuming false statements, and, by extension, the harm that comes from the sum of many people doing this. This research tends to see through the medium, emphasizing the directness of interactions on social media. \citet{cinelliCOVID19SocialMedia2020} provide us with a typical example:
...
This is a major departure from \citet{mcluhan_understanding_media_1964}'s famous and influential ``the medium is the message.'' When they do talk about social media in an active way, not just as a passive conduit for pseudo-direct interactions, they often discuss the platforms as potential collaborators in stopping misinformation, like, for example, developing tools to detect it~\cite{broda_misinformation_2024}. 

Despite its emphasis on social media, the misinformation paradigm looks less like media theory and more like \#1432's psychological research. There are modern scholars that continue the tradition of media research on social media~\cite{eichhornContent2022}, but one rarely finds references to it. Instead, misinformation research focuses on sources and content of misinformation, not its context, cultural form, or structural factors. 

This way of framing their inquiry is not self-evident. Given that, as discussed throughout this paper, most authors agree that the advent of social media is central to this line of inquiry, it could have been that the field coalesced around the political economy of social media, as \citet{hermanManufacturingConsent2021} did for mass media in 1988. Alternatively, misinformation scholars could have followed \citet{williamsTelevisionTechnologyCultural2004}'s example and looked at the cultural forms that these technological changes took. Instead, misinformation research inherits its understanding of the misinformation phenomenon from its predecessors. Except for a change in emphasis from the cognitive effects to the misinformation itself, this core conception remains recognizable from, for example, \citet{loftus_planting_2005}, decades later.
