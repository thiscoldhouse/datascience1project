...
If we follow the term ``misinformation'' all the way back through the academic literature, Scopus.com finds only 14 uses before 1950. After that, it enters the vocabulary as a not-too-common word, almost entirely in the medical field, though without the paradigm-defining weight it carries today. For example, \citet{CombatingFoodMisinformation}'s ``Combating Food Misinformation and Quackery'', from 1956, contains a familiar usage of the term. In the next year, however, we find \citet{johnInformationMisinformationGained1957}'s ``Information and Misinformation Gained from Fasting Blood Sugar Alone in Diabetes Therapy.''

This trend continues, with similar usage about the quality of information gained from some process, social or otherwise, albeit from more diverse fields. The medical field still dominates, but one finds, for example, \citet{gindinModelSovietFirm1970}'s``A Model of the Soviet Firm,'' which discusses Soviet firms' attempts to correct for ``systematic misinformation'' by changing the incentives of their bonus structure. In the 70s-90s, medical and public health still dominate, but we start to see more specialized uses, with perhaps slightly divergent, more technical (if metaphorically-linked) meanings, like those associated with computation~\cite{michelCategoricalApproachDistributed1989}.

Among these more specific, technical usages comes that of that of the ``misinformation effect,'' in which ``[e]xposure to misinformation after an event takes place puts memory accuracy at risk''~\cite{loftus_misinformation_2024}. In \citet{loftus_reconstruction_1974}'s ``Reconstruction of automobile destruction: An example of the interaction between language and memory,'' we see the beginning of that paradigm, one that will identify itself with that term in a direct, technical sense. Its experiments might involve asking a subject to recall something and, in the process, attempting to influence that memory in some way, perhaps by implication in the phrasing of her question~\cite{loftusPlantingMisinformationHuman2005b}. As we will see in Section~\ref{discussion}, in a striking historical parallel to today, this ``misinformation'' paradigm played an important role in public life during the Satanic Panic of the 1980s and 1990s.

In 2025, as we show in Section~\ref{results}, we have a new misinformation paradigm, one focused on social media, and one that has entered deep into the popular consciousness (e.g. see Figure~\ref{fig:twitter}). As always, with a new paradigm's success comes a re-interpretation of previously-known facts. ``Misinformation'' has, for example, been used to describe events in Rome~\cite{posetti_short_2018}, and even the activities of fish and other animals~\cite{fahimipour_wild_2023}. The paradigm's popularity means that such studies can garner attention in the popular press~\cite{times_evolution_2025}.

Previous work shows that the modern misinformation paradigm dates to roughly 2016, and that its existence is intertwined with the rise of social media~\cite{broda_misinformation_2024,donovan_express_2025}. These histories tend to begin with a general statement on the vast history of people saying and believing untrue things. They often cite technological upheavals in media as important factors, then specifically turn their focus to social media. We build upon those accounts of the post-paradigm history here. By analyzing academic papers published between 2011 and 2023 with the keyword ``misinformation'' in their metadata, we identify pre-2016 linguistic patterns unaccounted for in these histories~\cite{broda_misinformation_2024,donovan_express_2025,}, and we connect them to the ``misinformation effect.'' We argue that today's misinformation research owes more to this lineage than is generally acknowledged, and that this pre-existing strain of misinformation research (along with some other strains) finds itself increasingly absorbed into the new paradigm, bringing together previously distinct strands of researchers within a commonly-accepted framework~\cite{kuhn_structure_1962}. 

We conclude by noting the parallels between both the old and new misinformation paradigms. Both came about in moments of mass panic about evil forces doing harm to children, fueled by a changing media and political context. We are by no means the first to note the historical parallels between Qanon and the Satanic Panic, and we are much indebted to prior scholarship on this issue~\cite{hearst_qanon_2022}. Instead, our contribution is to note that, just as~\citet{hearst_qanon_2022} finds that modern conspiricism has roots in the Satanic Panic, so too can we trace the modern scientific response back to that of the 1980s. We hope that, by bringing this context to the fore, the scientific community can better navigate these moments of turbulence in the politically-contested nature of our shared reality.
...
Community \#1432 is mostly papers about the (un)reliability of memory, often in legal settings, and often involving witnesses like children or victims. Its most cited author is Elizabeth Loftus, and central to this community is the ``misinformation effect'', both discussed in Section~\ref{intro}.
...
Table~\ref{table:citations}, contains a selection of papers outside community \#1432 citing papers within it. \#1432 papers concern themselves primary with the individual, cognitive effects of having heard misinformation. Modern misinformation researchers might focus on how it circulates in social media. These are complimentary, often examining identical phenomena from slightly different perspectives. For example, \citet{brashierAgingEraFake2020}'s ``Aging in an Era of Fake News'' examines the susceptibility of older adults to misinformation on social media.

The complimentary nature of inside- and outside-\#1432 papers also allows for concepts that bridge the two. Both are, for example, interested in the efficacy of different strategies for combating misinformationn, or of ``prebunking''/``inoculating against misinformation.'' In papers like \citet{gradyNeverthelessPartisanshipPersisted2021}'s ``Nevertheless, Partisanship Persisted: Fake News Warnings Help Briefly, but Bias Returns with Time'' and \citet{murphyFalseMemoriesFake2019}'s False Memories for Fake News During Ireland's Abortion Referendum' (both co-authored by Loftus), we see research that fuses the concerns of today's misinformation paradigm of fake news and bias with the older focus on the cognitive effects of the misinformation. 
