...
Our methodology also restricted itself to the academic literature. As Figure~\ref{fig:twitter} hints, the term's meteoric rise in popularity is in no way restricted to the academy. We hope, in future work, to further explore how and why the term ``misinformation'' came to define the paradigm. Doing so would require an analysis that extends beyond journal articles.
