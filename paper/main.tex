...
There is no question that people say, and have always said, things that are not true, whether on social media or otherwise. That people do often believe these things, both to their individual and our social detriment, is similarly indisputable. Since 2016, in both formal and inforaml settings,we have described this phenomenon with the term ``misinformation'' (see Figure \ref{fig:twitter}). In the academic literature, it has come to represent a new scientific paradigm, one that, like all paradigms, comes with its own history and assumptions\cite{kuhn_structure_1962}.
