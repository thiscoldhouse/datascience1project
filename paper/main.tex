...
As discussed in Section~\ref{results}, these parallels are not a coincidence. Today's paradigm inherits from its predecessors. At its core, it focuses on individuals consuming false statements, and, by extension, the harm that comes from the sum of many people doing this. This research tends to see through the medium, emphasizing the directness of interactions on social media. \citet{cinelliCOVID19SocialMedia2020} provide us with a typical example:
...
This is a major departure from \citet{mcluhan_understanding_media_1964}'s famous and influential ``the medium is the message.'' When researchers do talk about social media in an active way, not just as a passive conduit for pseudo-direct interactions, they often discuss the platforms as potential collaborators in stopping misinformation, like, for example, developing tools to detect it~\cite{broda_misinformation_2024}. 

Despite its emphasis on social media, the misinformation paradigm looks less like media theory and more like \#1432's psychological research. There are modern scholars that continue the tradition of media research on social media~\cite{eichhornContent2022}, but one rarely finds references to it. Instead, misinformation research focuses on the content, sources, and consumers of misinformation, not its context, cultural form, or structural factors. 

This way of framing their inquiry is not self-evident. Given that, as discussed throughout this paper, most authors agree that the advent of social media is central to this line of inquiry, it could have been that the field coalesced around the political economy of social media, as \citet{hermanManufacturingConsent2021} did for mass media in 1988. Alternatively, misinformation scholars could have followed \citet{williamsTelevisionTechnologyCultural2004}'s example. In his 1973 analysis of television, he brings together the technology of broadcasting and cultural form of television to describe the ``flow'' state of watching television, a state that allows for a simultaneously communal yet private experience. There is a parallel here to ``doomscrolling,'' a popular concept that social media users deploy to explain their own behavior, yet we rarely find discussion in this vein.

Instead, misinformation is taken on its own terms, as content. Its harm is in its spread, and attempts to understand it in its totality involve adding up these individual interactions. When compared to ``misinformation effect'' research, there is a change in emphasis from the cognitive effects to the misinformation itself, along with an increase in scale, but the core conception remains recognizable.
