...
\date{\today}
\begin{abstract}
    We trace the history of the term `misinformation' through the years 2011-2023 in the academic literature. In agreement with much of the literature, we find that the modern misinformation paradigm formed around 2016. However, n analyzing the terms most associated with `misinformation' in research before and after 2016, we find that most histories and literature reviews fail to explain our pre-2016 findings. We fill the gap by identifying a consistent strand of `misinformation' research that goes back to the academic response to the Satanic Panic, and we argue that today's misinformation research owes more to this intellectual lineage than is generally understood. We conclude by drawing parallels between the Satanic Panic and today, and, similarly, between `misinformation' research then and now.
...
What is ‘misinformation’? We have heard about it in many contexts, including as a social contagion, fake news, something bought and sold, and more. How and why has it seemed to explode in academic circles in the last decade? Our project tracks the current conception of misinformation back in time to its primordial soup.
...
We used two datasets for this project: A Scopus.com export of all papers with ``misinformation'' in any metadata from 2011–2023, and the opencitations.net API. Save for the citations, all data came from the Scopus export. For the citations, we queried the opencitations.net API for all the references inside each paper. For every reference to another paper inside our database, we created a \texttt{Citation} object linking the two.
...
Community \#1432, however, hints at a previous paradigm, one that, as we will see, influenced the modern one, and one whose history contains important parallels to today's misinformation research. Its history begins in 1980, when Michelle Smith co-authored a book with her psychiatrist and soon-to-be-husband, Lawrence Pazder, titled \textit{Michelle Remembers}. In it, she recounts her gruesome experience being tortured at the hands of a Satanic cult, memories that, until recently, she had repressed. Pazder had used modern psychiatric techniques to help her recover these lost memories. These stories turned out to be grotesque fabrications, but the book, along with its credulous media coverage, triggered what became known as the Satanic Panic, in which found innocent daycare workers, members of the LGBT+ community, and others were convicted of ritually sacrificing babies to worship Satan \cite{hearst_qanon_2022,}\cite{shewan_conviction_2015}.
...
\begin{itemize}
    ...
    \item ... researchers sought to understand and combat the harm, often within the field itself, and often participating in public debate and in the very social processes they study. Misinformation literature in computer science journals, for example, often proposes ways to automatically detect misinformation on social media\cite{broda_misinformation_2024} while also seeing misinformation as a social media phenomenon. Likewise, Loftus participated as an expert witness for the defense in a criminal justice system that had locked up innocent people in several high-profile trials \cite{shewan_conviction_2015}.
